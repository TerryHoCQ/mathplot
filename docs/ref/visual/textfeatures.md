...
# `TextFeatures` for a mathplot label

TextFeatures is a small class that holds the attributes required to
specify the appearance of a string of text rendered by mathplot.
...
vm_ptr->addLabel ("Small text", {0, -1, 0}, mplot::TextFeatures(0.03f, 48, mplot::colour::springgreen));
```

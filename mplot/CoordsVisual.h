 ...
 * \file
 *
 * Defines a coordinate arrow class based on VisualModel
 *
 * \author Seb James
 * \date 2019
 */
...
namespace mplot
{
    ...
    class CoordsVisual : public VisualModel<glver>
    {
    public:
        CoordsVisual() : mplot::VisualModel<glver>() {}
        CoordsVisual (const sm::vec<float, 3>& offset) : mplot::VisualModel<glver>(offset) {}

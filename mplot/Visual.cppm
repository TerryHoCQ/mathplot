...
export namespace mplot
{
    ...
    public:
        ...
        void init_resources()
        {
            ...
            mplot::VisualResources<glver>::i().setContext_implementation = mplot::VisualGlfw<glver>::setContext;
            mplot::VisualResources<glver>::i().releaseContext_implementation = mplot::VisualGlfw<glver>::releaseContext;

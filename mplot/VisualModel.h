 ...
 *
 * This leaves a path open to having VisualModel_AltGraphicsSystem (VisualModelVulkan?).
 *
 * \author Seb James
 * \date March 2025
 */
...
namespace mplot
{
    ...
    struct VisualModel : public mplot::VisualModelBase<glver>
    {
        VisualModel() : mplot::VisualModelBase<glver>::VisualModelBase() {}
        VisualModel (const sm::vec<float>& _offset) : mplot::VisualModelBase<glver>::VisualModelBase(_offset) {}
